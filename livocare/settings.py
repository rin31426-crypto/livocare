...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', '')  # سيقرأ من متغيرات البيئة
EMAIL_HOST_PASSWORD = os.environ.get('SENDGRID_API_KEY', '')  # سيقرأ المفتاح
DEFAULT_FROM_EMAIL = f'LivoCare <{EMAIL_HOST_USER}>'
# ==============================================================================
